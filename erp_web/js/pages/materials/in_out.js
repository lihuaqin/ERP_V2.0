	...
	function initTableData_material_show(TotalPrice){
		...
		$('#materialDataShow').datagrid({
			...
			columns:[[
                ...
                { title: '库存',field: 'Stock',width:70 ,hidden:true},
				...
				{ title: '单价',field: 'UnitPrice',editor:'validatebox',width:60},
				{ title: '含税单价',field: 'TaxUnitPrice',editor:'validattebox',hidden:true,width:75},
				{ title: '金额',field: 'AllPrice',editor:'validatebox',width:75},
	...
	function bindEvent(){
        ...
        $("#exportDepotHeadShow").off("click").on("click",function(){
           window.location.href="/depotItem/exportDetailList";
		});
